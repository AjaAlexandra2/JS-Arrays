...
function divider (numbersArray) {
    var even = []; //made my two empty arrays
    var odd = [];
     for (var i =0; i < numbersArray.length; i++) { //looping though
      if ( numbersArray[i] % 2 !== 0) { //checking to see if even
